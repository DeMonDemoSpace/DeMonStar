...
import com.demon.baseui.image.StrongImageDelegate.ImageDrawable;
 ...
 */
public class StrongImageView extends View implements StrongImage, StrongImageDelegate.Callback {
    ...
    private StrongImageDelegate mDelegate;
    ...
    public StrongImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    protected void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        mDelegate = new StrongImageDelegate(getResources().getDisplayMetrics(), this);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StrongImageView);

        mDelegate.setScaleType(ScaleType.valueOf(
                a.getInt(R.styleable.StrongImageView_scaleType, ScaleType.FIT_CENTER.nativeInt)));

        mDelegate.setAnimateScaleType(
                a.getBoolean(R.styleable.StrongImageView_animateScaleType, false));

        mDelegate.setMinimumScale(
                a.getFloat(R.styleable.StrongImageView_minimumScale, 0f));

        mDelegate.setMaximumScale(
                a.getFloat(R.styleable.StrongImageView_maximumScale, Float.MAX_VALUE));

        mDelegate.setScale(a.getFloat(R.styleable.StrongImageView_scale, -1f));
