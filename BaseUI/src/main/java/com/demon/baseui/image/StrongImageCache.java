...
public class StrongImageCache extends StrongCache<Integer, StrongImageCache.ImageCache, Void> {
    ...
    public class ImageCache extends StrongCache<Point, Bitmap, Integer> {
        ...
        protected Bitmap alternative(Point key, Integer level) {
            ...
            if (level > 1) {
                ImageCache imageCache = StrongImageCache.this.justGet(level >> 1);
                if (imageCache != null) {
