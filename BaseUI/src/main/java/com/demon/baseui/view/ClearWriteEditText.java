...
public class ClearWriteEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.drawable.clear_write);
    ...
    public void setClearDrawable(Drawable mClearDrawable) {
        ...
        this.mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
    }
}
