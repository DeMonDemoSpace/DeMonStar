 ...
 */
public class ArrowDownloadView extends ConstraintLayout {
    ...
    public ArrowDownloadView(Context context) {
        this(context, null);
    }

    public ArrowDownloadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArrowDownloadView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initializePaints() {
        ...
        arcPaint.setColor(context.getResources().getColor(R.color.base_light_gray));
       ...
       /* arrowPaint.setColor(WHILE);*/
        arrowPaint.setColor(context.getResources().getColor(R.color.colorAccent));

        smallPaint = new Paint();
        smallPaint.setAntiAlias(true);
        smallPaint.setStyle(Paint.Style.FILL);
        /*smallPaint.setColor(WHILE);*/
        smallPaint.setColor(context.getResources().getColor(R.color.colorAccent));
        ...
        triPaint.setColor(context.getResources().getColor(R.color.colorAccent));
        ...
        loadingPaint.setColor(context.getResources().getColor(R.color.base_blue));
        ...
        textPaint.setColor(context.getResources().getColor(R.color.base_blue));
    }
