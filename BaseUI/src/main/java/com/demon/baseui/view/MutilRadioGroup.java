...
import com.demon.baseutil.UnitUtil;
 ...
 * @description
 */
public class MutilRadioGroup extends RadioGroup {
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MutilRadioGroup);
            grivate = typedArray.getInt(R.styleable.MutilRadioGroup_mrg_gravity, grivate);
            horizontal_Space = typedArray.getDimension(R.styleable.MutilRadioGroup_mrg_horizontal_Space, UnitUtil.dp2px(context, 10));
            vertical_Space = typedArray.getDimension(R.styleable.MutilRadioGroup_mrg_vertical_Space, UnitUtil.dp2px(context, 10));
            isFull = typedArray.getBoolean(R.styleable.MutilRadioGroup_mrg_isFull, false);
            typedArray.recycle();
        }
    }
