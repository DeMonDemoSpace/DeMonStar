...
public class PaintView extends View {
    ...
    private void clearPaint() {
        ...
        if (hasLines) {
            ...
            linePaint.setStrokeJoin(Paint.Join.ROUND);//使画笔更加圆润
            linePaint.setStrokeCap(Paint.Cap.ROUND);//同上
            for (int i = 70; i < getHeight(); i += 70) {
                mCanvas.drawLine(15, i, getWidth() - 15, i, linePaint);
            }
        }
        invalidate();
    }
    ...
    public void setHasLines(boolean hasLine) {
        this.hasLines = hasLine;
    }
}
