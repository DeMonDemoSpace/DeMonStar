...
import com.demon.baseframe.util.ScreenSizeUtils;
import com.demon.baseutil.ScreenUtil;
...
public class StatusBarUtil {
     ...
     * @param toolbar
     */
    public static void setImmerseBar(Activity activity, final Toolbar toolbar, AppBarLayout appbar) {
        // 沉浸模式
        setTransparentForWindow(activity);
        toolbar.getBackground().setAlpha(0);
        int statusBarHeight = ScreenSizeUtils.getInstance().getStatusBarHeight(activity);
        toolbar.setPadding(0, statusBarHeight, 0, 0);
        toolbar.getLayoutParams().height = ScreenUtil.dp2px(activity, 45.0F) + statusBarHeight;

        final int alphaMaxOffset = ScreenUtil.dp2px(activity, 150.0F);
