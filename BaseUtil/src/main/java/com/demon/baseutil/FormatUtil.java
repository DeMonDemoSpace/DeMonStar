...
public class FormatUtil {
    ...
    public static boolean isMobileNO(String mobiles) {
		 ...
		 */
        String telRegex = "[1][3465789]\\d{9}";
        //"[1]"代表第1位为数字1，"[3465789]"代表第二位可以为3、5、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
    ...
    public static boolean IDCardValidate(String IDStr) throws ParseException {
        ...
        if (IDStr.length() != 15 && IDStr.length() != 18) {
            ...
            Log.i(TAG, "ID:" + "errorInfo=" + errorInfo);
            return false;
        }
        // =======================(end)========================
        ...
        try {
            if ((gc.get(Calendar.YEAR) - Integer.parseInt(strYear)) > 150 || (gc.getTime()
    ...
    private static boolean isDataFormat(String str) {
        ...
        String regxStr = "^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|" +
                ...
                "(1[0-9])|(2[0-8]))))))(\\s(((0?[0-9])|([1-2][0-3]))\\:([0-5]?[0-9])((\\s)|(\\:" +
                "([0-5]?[0-9])))))?$";
     ...
     * @return
     */
    public static boolean checkFirstChar(String fstrData) {
